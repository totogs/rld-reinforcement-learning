...
if __name__ == '__main__':
    ...
    agent = DeepDeterministicPG(1,2, aLow=env.action_space.low[0], aHigh=env.action_space.high[0], plr=0.001, lr=0.01, rhoP=0.9, rhoQ=0.5,  c_update=1000, n_update=60, batch_size=100)
