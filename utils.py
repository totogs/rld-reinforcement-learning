...
class CheckpointState():
    ...
    def save(self, suffix=''):
        if suffix:
            savepath = Path(self.prefix+self.savepath.stem + suffix + self.savepath.suffix)
        else:
            savepath = Path(self.prefix + self.savepath.stem + self.savepath.suffix)
